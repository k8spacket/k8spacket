...
func (mockTlsParserService *mockTlsParserService) buildConnectionsResponse(url string) ([]model.TLSConnection, error) {
...
func (mockTlsParserService *mockTlsParserService) buildDetailsResponse(url string) (model.TLSDetails, error) {
	if strings.Contains(url, "scenario=error") {
