...
import (
	...
	httpclient "github.com/k8spacket/k8spacket/internal/external/http"
	k8sclient "github.com/k8spacket/k8spacket/internal/external/k8s"
	"github.com/k8spacket/k8spacket/internal/modules/tls-parser/certificate"
	"github.com/k8spacket/k8spacket/internal/modules/tls-parser/model"
	"github.com/k8spacket/k8spacket/internal/modules/tls-parser/repository"
	"github.com/stretchr/testify/assert"
)

var dbState = []model.TLSConnection{
	model.TLSConnection{Id: "id1", Src: "src1"},
	model.TLSConnection{Id: "id2", Src: "src2"},
}
...
func (mockCertificate *mockCertificate) UpdateCertificateInfo(newValue *model.TLSDetails, oldValue *model.TLSDetails) {
	mockCertificate.fnCalled = true
}
...
func TestStoreInDatabase(t *testing.T) {
	...
	service := Service{mockRepository, mockCertificate, &httpclient.HttpClient{}, &k8sclient.K8SClient{}}
	...
	assert.EqualValues(t, true, mockCertificate.fnCalled)

}

func TestRead(t *testing.T) {
	mockRepository := &mockRepository{}
	service := Service{mockRepository, &certificate.Certificate{}, &httpclient.HttpClient{}, &k8sclient.K8SClient{}}
...
func TestBuildConnectionsResponse(t *testing.T) {
	...
	service := Service{&repository.Repository{}, &certificate.Certificate{}, mockHttpClient, mockK8SClient}
