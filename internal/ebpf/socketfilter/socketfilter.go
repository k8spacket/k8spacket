...
func (socketFilterEbpf *SocketFilterEbpf) Init() {
	...
	go func() {
		...
		for {
			...
			distribute(event, socketFilterEbpf)
		}
	}()
...
func distribute(event socketfilterTlsHandshakeEvent, socketFilterEbpf *SocketFilterEbpf) {
	...
	socketFilterEbpf.Broker.TLSEvent(tlsEvent)
}
